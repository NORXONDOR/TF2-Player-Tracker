...
while menu_choice != 'X':
    ...
    match menu_choice:
        case '1':
            steamid3 = input("SteamID3 (without brackets): ")
            ...
            if response.status_code == 200:
                ...
                persona_name = unclean_persona_name.replace('.1.h', '').replace(';', '') # Remove .1.h and ;, character combinations used to delimit database entry information.
            else:
